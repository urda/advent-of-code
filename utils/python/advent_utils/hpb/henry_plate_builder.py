...
class HenryPlateBuilder:
    ...
    def pre_stage_day(cls, year_token: int) -> None:
        ...
        init_file_path = Path(
            ...
            f'advent_days/day_{day_token:02d}/__init__.py'
        )
        src_file_path = Path(
            cls.build_src_root_path(),
            f'advent_days/day_{day_token:02d}/day_{day_token:02d}.py'
        )
        test_file_path = Path(
            cls.build_tests_root_path(),
            f'advent_days/test_day_{day_token:02d}.py'
        )
